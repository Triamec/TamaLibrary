...
/* Overview
 * --------
 * This pulse generator Tama program is able to output periodical pulses at TSD Ax0..Ax1 DigOutputs 1..2.
...
static class PulseGeneratorTsd {
	#region Constants
	/// <summary>
	...
	static void SetDigitalOutput(int outIdx, int value) {
		switch (OutputAxisIdx[outIdx]) {
			...
			case 1:
				switch (OutputPinIdx[outIdx]) {
					case 0:
						Register.Axes_1.Commands.General.DigitalOut1 = value > 0;
						break;
					case 1:
						Register.Axes_1.Commands.General.DigitalOut2 = value > 0;
						break;
					default:
						// unused 
						break;
